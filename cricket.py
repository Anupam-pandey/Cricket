...
class GetCricket:
    ...
    def last_wicket(self):
        return 'Last Wicket: '+self.player.get(self.score.get('last_wkt'), 'No') + ' ' + self.score.get('last_wkt_score', 'Wicket') + '\n' + self.over_flow + '\n'+self.commentary.get('comm', '')
    ...
    def update_changes(self):
        ...
        self.bowling_team = self.team.get(self.score.get('bowling', {}).get('id', str(self.team_sum-int(self.score.get('batting', {}).get('id',0)))), '')
